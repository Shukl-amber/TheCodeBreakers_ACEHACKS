    ...
    <section class="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div class="max-w-xl mx-auto text-center">
                ...
                <p class="mt-5 text-base text-white sm:text-xl">Effortless inventory control for business owners</p>
                <Link to="/connectShopify" class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700">Start Now</Link>
                {/* <a to='/connectShopify' title="" class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700" role="button">
                    Start Now
                    <svg class="w-6 h-6 ml-4 -mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                    <div class="flex items-center">
                        ...
                        <p class="ml-3 text-sm text-white">Over 500 Organizations joined</p>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="ml-3 text-sm text-white">Automate your data</p>
                    </div>
